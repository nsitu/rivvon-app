...
loadMaterialSymbols([ 
    ...
    'account_circle', 'crop', 'save', 'folder','texture','arrow_back', 'video_camera_back_add','arrow_back_ios','check','done_outline','visibility','hard_drive','cloud_upload','folder_zip'
]);
