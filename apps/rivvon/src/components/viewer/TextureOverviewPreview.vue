<script setup>
    ...
    watch(
        () => [props.showBlurredBackground, app.animatedBackgroundEnabled, app.backgroundFlipVertical, app.backgroundBlurEnabled, app.backgroundBlurAmount, app.backgroundTextureEnabled, app.backgroundTexture],
        async ([enabled]) => {
