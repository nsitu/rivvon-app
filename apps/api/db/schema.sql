...
-- Rendered video exports published to the gallery
...
-- User-owned audio assets, stored as audio-only files in R2.
CREATE TABLE IF NOT EXISTS audio_assets (
    ...
    pitch_mode TEXT NOT NULL DEFAULT 'tape-speed',
    sample_rate INTEGER,
