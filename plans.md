...
we can use 3d face detection via the webcam to allow control of the camera orbit via the user's head movements. We can get inspiration from https://github.com/nsitu/3D-mirror we will need to study how to do this in threejs since the inspiration example uses p5js.
